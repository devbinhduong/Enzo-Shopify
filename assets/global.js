...
class SwiperComponent extends HTMLElement {
  constructor() {
    ...
    this.isFreeModeMobile = this.hasAttribute("data-free-mode");
  }
  get items() {
  ...
  initSwiperMobile() {
    ...
    this.breakpointChecker = () => {
      ...
      if (isMobile && this.isFreeModeMobile) {
        if (this.initSwiper) {
          this.initSwiper.destroy(true, true);
          this.initSwiper = null;
        }
...
function checkWishlistCountGlobal(wishlistList) {
  const wishlistIcon = document.querySelectorAll('.header-wishlist');
        ...
        [
          this.details,
          {
            height: this.contentElement.classList.contains(
              ...
              ? `${this.summaryElement.clientHeight + getComputedStyle(this.summaryElement).marginTop + getComputedStyle(this.summaryElement).marginBottom}px`
              : [
              `${this.summaryElement.clientHeight + getComputedStyle(this.summaryElement).marginTop + getComputedStyle(this.summaryElement).marginBottom}px`,
              `${this.summaryElement.clientHeight + getComputedStyle(this.summaryElement).marginTop + getComputedStyle(this.summaryElement).marginBottom + this.contentElement.scrollHeight}px`,
            ],
          },
