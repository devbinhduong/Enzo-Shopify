  ...
  (function( jQuery ){
  var $module = jQuery('#m-1726562809504').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1726562809504";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1726562809504") {
      window.getTab1726562809504 = function() {
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1726562809635').children('.module');
    ...
    $module.children('[data-accordion]').children('[data-content]').children().css('border-bottom', borderSize + ' solid ' + borderColor);
      ...
      (function( jQuery ){
  try {
    var $module = jQuery('#m-1726562809654').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1726562809657').children('.module');

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'production') { 
    $module.children('form').on('submit', function() {
      try {
        localStorage.setItem('gemId', '#m-1726562809657');
      } catch(err) {}
    });
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1726562809678').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
